...
- (void)viewDidLoad
{
    ...
    UIInputView *numberView = [[UIInputView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.view.frame), 50) inputViewStyle:UIInputViewStyleDefault];
    
    QEDKeyboardButton *aButton = [[QEDKeyboardButton alloc] initWithFrame:CGRectMake(53, 5, 26, 40) input:@"Q" inputOptions:@[@"A", @"B", @"C"]];
